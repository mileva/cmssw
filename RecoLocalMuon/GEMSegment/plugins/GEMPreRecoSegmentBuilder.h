#ifndef GEMRecHit_GEMPreRecoSegmentBuilder_h
#define GEMRecHit_GEMPreRecoSegmentBuilder_h
...
public:
     ...
     */
    explicit GEMPreRecoSegmentBuilder(const edm::ParameterSet&);
    /// Destructor
    ~GEMPreRecoSegmentBuilder();

    /** Find rechits in each ensemble of 6 GEM layers, build GEMSegment's ,
     *  and fill into output collection.
     */
    void build(const GEMRecHitCollection* rechits, GEMSegmentCollection& ocT);

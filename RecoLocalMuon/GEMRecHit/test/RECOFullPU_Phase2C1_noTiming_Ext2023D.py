...
# with command line options: step3 --conditions 90X_upgrade2023_realistic_v1 -n 10 --era Phase2C1 --eventcontent FEVTDEBUGHLT --runUnscheduled -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --geometry Extended2023D9 --no_exec --python RECOFullPU_Phase2C1_noTiming_Ext2023D.py --filein file:step2.root  

...
std::cout << "echo from processLook" << std::endl;
  ...
  for (const auto&& rpcdgIt : (*rpcDigis)) {
    ...
    for (auto cl : cls){
      ...
      std::cout << "my rawId: " << rawId << "\tmy BX: " << Bx << "\tmy first strip: " << firststrip << "\tmy cls: " << clustersize << std::endl;
      std::cout << "my LocalPoint: " << lPos << std::endl;
...
std::cout << "echo from process" << std::endl;
  ...
  for (const auto&& rpcdgIt : (*rpcDigis)) {
    ...
    for (auto cl : cls){
      ...
      std::cout << "process rawId: " << rawId << "\tprocessy BX: " << Bx << "\tprocess first strip: " << firststrip << "\tprocess cls: " << clustersize << std::endl;
      std::cout << "process LocalPoint: " << lPos << std::endl;

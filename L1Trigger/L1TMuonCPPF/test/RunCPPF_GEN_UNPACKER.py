...
in_dir_name = '/afs/cern.ch/user/c/chengl/public/cppftest/'
readFiles.extend( cms.untracked.vstring('file:'+in_dir_name+'testRPCCPPF.root') )
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('rpcrechits_step')
    ),
   ...
   outputCommands = cms.untracked.vstring('drop *',"keep *_RPCCPPFRawToDigi_*_*", "keep *_simCppfDigis_*_*", 
	"keep *_rpcRecHits_*_*"),
...
process.rpcRecHits.rpcDigiLabel = 'rpcUnpackingModule'
...
# Schedule definition
process.schedule = cms.Schedule(process.rpcrechits_step,process.simCppfDigis_step,process.endjob_step,process.FEVTDEBUGHLToutput_step)
